...
class _HirerDashboardState extends State<HirerDashboard> {
  ...
  // from here i added this replace with blank space
  Widget buildHiringTipsCard() {
    return Container(
        ...
        children: [
          ...
          Row(
            children: const [
              ...
              SizedBox(width: 10),
              Expanded(
                child: Text("Post detailed job descriptions to attract skilled workers."),
              ),
            ],
          ),
          SizedBox(height: 25),
          Row(
            children: const [
              ...
              SizedBox(width: 10),
              Expanded(
                child: Text("Verify your business info to build trust."),
              ),
            ],
          ),
          SizedBox(height: 25),
          Row(
            children: const [
              ...
              SizedBox(width: 10),
              Expanded(
                child: Text("here is good opportunity apply early to get hired early."),
              ),
            ],
          ),
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () =>
                          Navigator.pushNamed(context, '/past_workers'),
